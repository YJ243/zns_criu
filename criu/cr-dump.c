...
// dump function with pid (yejin)
int cr_dump_tasks(pid_t pid)
{
	/*
		criu/images/inventory.pb-c.h: struct _InventoryEntry{}
	...
	*/
	...
	// open image file init function (yejin)
	...
	// (yejin) function of writing image inventory
	//printf("(yejin)finish collecting and freezing process tree\n");
...
err:
	...
	int rett =cr_dump_finish(ret); 

	// (yejin) finish function cr_dump_tasks()
	//printf("(yejin)return cr_dump_tasks()\n");
	//cr_zns_show(&file_to_zone_map);
